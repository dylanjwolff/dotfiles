 ...
 * |-----------------------------------------------------------------------------------------------------------------------|
 * | Brite       |      |   {     | Alt / [ | GUI / { | NUM / | SYM / | GUI / }| ALT / ] |      }  |            |  Right   |
 * |             |      |         |         |         | Space | Enter |        |         |         |            |          |
 * `-----------------------------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT,  KC_NO,  KC_LCBR, LALT_T(KC_LBRACKET), LGUI_T(KC_LCBR), LT(_NUMBER, KC_SPC),  LT(_SYMBOL, KC_ENT), RGUI_T(KC_RCBR), RALT_T(KC_RBRACKET), KC_RCBR,     KC_NO,   KC_RGHT
),
 ...
 * |----------------------------------------------------------------------------------------------------------------------|
 * | Ctrl / Esc  |   1  |   2     |    3    |    4   |   5   |   6   |    7   |    8    |    9    |     0     | Ctrl /  " |
 * |----------------------------------------------------------------------------------------------------------------------|
 * | Shift / (   |      |         |         |        |       |       |        |         |         |           | Shift / ) |
 * |----------------------------------------------------------------------------------------------------------------------|
 * | Brite       |      |   {     | Alt / [ |GUI / { | NUM / | SYM / | GUI / }| ALT / ] |      }  |           |  Right    |
...
/* Symbol
 * ,----------------------------------------------------------------------------------------------------------------------.
 * | Tab         |  F11 |   F12   |   F13   |   F14  |  F15  |  F16  |   F17  |   F18   |   F19   |    F20    | Bksp      |
 * |----------------------------------------------------------------------------------------------------------------------|
 * | Ctrl / Esc  |   !  |   @     |    #    |    $   |   %   |   ^   |    &   |    *    |    '    |     "     | Ctrl /  " |
 * |----------------------------------------------------------------------------------------------------------------------|
 * | Shift / (   |   ~  |    `    |         |    _   |       |   +   |    -   |    =    |    \    |     |     | Shift / ) |
 ...
 * | Shift / (   |      |         |         |        |       |       |        |         |         |           | Shift / ) |
 * |----------------------------------------------------------------------------------------------------------------------|
 * | Brite       |   {  | Alt / [ | GUI / { | Number | Space | Enter | Symbol | GUI / } | ALT / ] |      }    | Right     |
 * `----------------------------------------------------------------------------------------------------------------------'
 */
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  NUMBER,  SYMBOL,  PLOVER,  _______,
